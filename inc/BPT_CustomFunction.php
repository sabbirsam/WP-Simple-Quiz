 ...
 */
function bbt_features_get_template( string $template, array $variables = [], bool $echo = false ) {

	$template_file = sprintf( '%1$s/templates/%2$s.php', untrailingslashit( plugin_dir_path( __DIR__ ) ), $template );
